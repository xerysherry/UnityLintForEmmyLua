...
--- @param xBase number First x index of heightmap samples to retrieve.
--- @param yBase number First y index of heightmap samples to retrieve.
--- @param width number Number of samples to retrieve along the heightmap's x axis.
--- @param height number Number of samples to retrieve along the heightmap's y axis.
--- @return number[] 
