--- @class UnityEngine.UIElements.DragExitedEvent:UnityEngine.UIElements.DragAndDropEventBase`1 The event sent to a dragged element when the drag and drop process ends.
...
--- @param systemEvent UnityEngine.Event An IMGUI drag exited event.
--- @return UnityEngine.UIElements.DragExitedEvent An initialized event.
