--- @class UnityEngine.UIElements.ManipulatorActivationFilter Used by manipulators to match events against their requirements.
...
--- @return boolean True if the event matches the requirements.
