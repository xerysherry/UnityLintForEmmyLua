--- @class UnityEngine.UIElements.MouseEnterEvent:UnityEngine.UIElements.MouseEventBase`1 Event sent when the mouse pointer enters an element or one of its descendent elements. The event is cancellable, it does not trickle down, and it does not bubble up.
