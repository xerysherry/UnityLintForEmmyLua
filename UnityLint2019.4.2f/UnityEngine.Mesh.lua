...
--- Gets the bone weights of the Mesh.
...
--- @param weights Unity.Collections.NativeArray`1 Bone weights sorted by vertex index and then by descending weight for each vertex.
