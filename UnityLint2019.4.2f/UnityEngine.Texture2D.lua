--- @class UnityEngine.Texture2D:UnityEngine.Texture Class for texture handling.
...
--- @return boolean If the function succeeds, this will contain the packed rectangles.  Otherwise, the return value is null.
