--- @class UnityEngine.UIElements.BindableElement:UnityEngine.UIElements.VisualElement Element that can be bound to a property.
...
--- @param value UnityEngine.UIElements.IBinding 
