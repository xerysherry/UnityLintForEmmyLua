--- @class UnityEngine.Rendering.BuiltinShaderDefine Defines set by editor when compiling shaders, depending on target platform and tier.
UnityEngine.Rendering.BuiltinShaderDefine = {
    ...
    --- UNITY_LIGHT_PROBE_PROXY_VOLUME is set when Light Probe Proxy Volume feature is supported by the current graphics API and is enabled in the current Tier Settings(Graphics Settings).
