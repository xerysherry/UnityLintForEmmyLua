--- @class UnityEngine.UIElements.PointerStationaryEvent:UnityEngine.UIElements.PointerEventBase`1 An event sent when a pointer does not change for a set amount of time determined by the operating system.
