--- @class UnityEngine.UIElements.BlurEvent:UnityEngine.UIElements.FocusEventBase`1 Event sent immediately after an element has lost focus. This event trickles down, it does not bubble up, and it cannot be cancelled.
