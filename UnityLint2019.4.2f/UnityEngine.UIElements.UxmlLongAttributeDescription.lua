--- @class UnityEngine.UIElements.UxmlLongAttributeDescription:UnityEngine.UIElements.TypedUxmlAttributeDescription`1 Describes a XML long attribute.
...
--- @param bag UnityEngine.UIElements.IUxmlAttributes The bag of attributes.
--- @param cc UnityEngine.UIElements.CreationContext The context in which the values are retrieved.
--- @param value System.Int64& The value of the attribute.
--- @return boolean True if the value could be retrieved, false otherwise.
function UnityEngine.UIElements.UxmlLongAttributeDescription:TryGetValueFromBag(bag, cc, value) end
