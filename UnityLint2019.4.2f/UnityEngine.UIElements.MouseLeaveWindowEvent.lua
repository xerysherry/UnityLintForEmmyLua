--- @class UnityEngine.UIElements.MouseLeaveWindowEvent:UnityEngine.UIElements.MouseEventBase`1 Event sent when the mouse pointer exits a window. The event is cancellable, it does not trickle down, and it does not bubble up.
...
--- @param systemEvent UnityEngine.Event An IMGUI MouseLeaveWindow event.
--- @return UnityEngine.UIElements.MouseLeaveWindowEvent An initialized event.
