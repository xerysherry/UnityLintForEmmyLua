--- @class UnityEngine.UIElements.MouseDownEvent:UnityEngine.UIElements.MouseEventBase`1 Mouse down event.
...
--- @return UnityEngine.UIElements.MouseDownEvent An initialized event.
