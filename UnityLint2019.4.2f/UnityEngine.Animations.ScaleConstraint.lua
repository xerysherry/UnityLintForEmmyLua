--- @class UnityEngine.Animations.ScaleConstraint:UnityEngine.Behaviour Constrains the scale of an object relative to the scale of one or more source objects.
--- @field weight number property getset
---       The weight of the constraint component.
--- @field scaleAtRest UnityEngine.Vector3 property getset
---       The scale used when the sources have a total weight of 0.
--- @field scaleOffset UnityEngine.Vector3 property getset
---       The offset from the constrained scale.
--- @field scalingAxis UnityEngine.Animations.Axis property getset
