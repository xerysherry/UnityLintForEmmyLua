--- @class UnityEngine.UIElements.PointerLeaveEvent:UnityEngine.UIElements.PointerEventBase`1 Event sent when a pointer exits an element and all of its descendant.
