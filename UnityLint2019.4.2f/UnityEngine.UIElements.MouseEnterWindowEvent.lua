--- @class UnityEngine.UIElements.MouseEnterWindowEvent:UnityEngine.UIElements.MouseEventBase`1 Event sent when the mouse pointer enters a window. The event is cancellable, it does not trickle down, and it does not bubble up.
