--- @class UnityEngine.UIElements.MouseOverEvent:UnityEngine.UIElements.MouseEventBase`1 Event sent when the mouse pointer enters an element. The event trickles down, it bubbles up, and it is cancellable.
