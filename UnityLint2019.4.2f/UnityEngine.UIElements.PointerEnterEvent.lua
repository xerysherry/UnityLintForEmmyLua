--- @class UnityEngine.UIElements.PointerEnterEvent:UnityEngine.UIElements.PointerEventBase`1 Event sent when a pointer enters a VisualElement or one of its descendant.
