--- @class UnityEngine.UIElements.KeyUpEvent:UnityEngine.UIElements.KeyboardEventBase`1 Event sent when a key is released on the keyboard. This event trickles down and bubbles up. This event is cancellable.
