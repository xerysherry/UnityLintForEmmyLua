--- @class UnityEngine.UIElements.FocusInEvent:UnityEngine.UIElements.FocusEventBase`1 Event sent immediately before an element gains focus. This event trickles down and bubbles up. This event cannot be cancelled.
