--- @class UnityEngine.UIElements.MouseOutEvent:UnityEngine.UIElements.MouseEventBase`1 Event sent when the mouse pointer exits an element. The event trickles down, it bubbles up, and it is cancellable.
