--- @class UnityEngine.XR.WSA.HolographicRemoting The Holographic Remoting interface allows you to connect an application to a remote holographic device, and to stream data between the application and that device.
