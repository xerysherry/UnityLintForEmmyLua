--- @class UnityEngine.XR.WSA.Input.NavigationUpdatedEventArgs Contains fields that are relevant when a navigation gesture updates.
--- @field source UnityEngine.XR.WSA.Input.InteractionSource property get
---       The InteractionSource (hand, controller, or user's voice) being used for the navigation gesture.
