--- @class UnityEngine.UIElements.SliderInt:UnityEngine.UIElements.BaseSlider`1 A slider containing Integer discrete values.
...
--- @field pageSize number property getset
...
--- @param value number 
function UnityEngine.UIElements.SliderInt:set_pageSize(value) end
