--- @class UnityEngine.UIElements.ImmediateModeElement:UnityEngine.UIElements.VisualElement VisualElement that can implement custom immediate mode rendering.
