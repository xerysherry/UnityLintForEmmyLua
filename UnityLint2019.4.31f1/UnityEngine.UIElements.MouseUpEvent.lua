--- @class UnityEngine.UIElements.MouseUpEvent:UnityEngine.UIElements.MouseEventBase`1 Mouse up event.
...
--- @return UnityEngine.UIElements.MouseUpEvent An initialized event.
