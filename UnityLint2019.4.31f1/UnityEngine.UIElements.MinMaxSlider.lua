--- @class UnityEngine.UIElements.MinMaxSlider:UnityEngine.UIElements.BaseField`1 A min/max slider containing a representation of a range.
...
--- @field trackerUssClassName string USS class name of tracker elements in elements of this type.
--- @field draggerUssClassName string USS class name of dragger elements in elements of this type.
--- @field minThumbUssClassName string USS class name of the minimum thumb elements in elements of this type.
--- @field maxThumbUssClassName string USS class name of the maximum thumb elements in elements of this type.
