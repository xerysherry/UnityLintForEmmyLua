--- @class UnityEngine.UIElements.CustomStyleResolvedEvent:UnityEngine.UIElements.EventBase`1 Event sent after the custom style properties of a VisualElement have been resolved.
