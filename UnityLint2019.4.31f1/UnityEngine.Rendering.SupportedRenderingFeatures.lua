...
---       Determines if the renderer supports automatic generation of a default ambient probe.
--- @field autoDefaultReflectionProbeBaking boolean property getset
---       Determines if the renderer supports automatic generation of a default reflection probe.
