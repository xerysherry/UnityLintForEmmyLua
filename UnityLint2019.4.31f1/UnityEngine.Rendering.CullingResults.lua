--- @class UnityEngine.Rendering.CullingResults A struct containing the results of a culling operation.
...
--- @param allocator Unity.Collections.Allocator The allocator to use.
...
--- If a RenderPipeline sorts or otherwise modifies the VisibleLight list, an index remap will be necessary to properly make use of per-object light lists.
--- @param lightIndexMap Unity.Collections.NativeArray`1 Array with light indices that map from VisibleLight to internal per-object light lists.
...
--- If a RenderPipeline sorts or otherwise modifies the VisibleReflectionProbe list, an index remap will be necessary to properly make use of per-object reflection probe lists.
--- @param lightIndexMap Unity.Collections.NativeArray`1 Array with reflection probe indices that map from VisibleReflectionProbe to internal per-object reflection probe lists.
