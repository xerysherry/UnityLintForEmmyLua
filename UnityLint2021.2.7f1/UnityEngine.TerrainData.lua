...
--- @param patchX number The x index of the patch.
--- @param patchY number The y index of the patch.
--- @param layer number The prototype index.
--- @param density number The density setting of the detail.
--- @return UnityEngine.DetailInstanceTransform[] 
--- @return UnityEngine.Bounds& Returns the bounds of the detail objects.
function UnityEngine.TerrainData:ComputeDetailInstanceTransforms(patchX, patchY, layer, density) end
...
--- @param density number The detail density value. See Terrain.detailObjectDensity.
