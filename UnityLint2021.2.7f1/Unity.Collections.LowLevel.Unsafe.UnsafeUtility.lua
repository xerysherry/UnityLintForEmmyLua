...
--- @param from Unity.Collections.LowLevel.Unsafe.U& The reference to reinterpret.
--- @return Unity.Collections.LowLevel.Unsafe.T& A reference to a value of type T.
function Unity.Collections.LowLevel.Unsafe.UnsafeUtility.As(from) end

--- Gets a reference to the struct at its current location in memory.
--- @param ptr System.Void* The pointer of struct to reference.
--- @return Unity.Collections.LowLevel.Unsafe.T& A reference to a value of type T.
function Unity.Collections.LowLevel.Unsafe.UnsafeUtility.AsRef(ptr) end

--- Gets a reference to the array element at its current location in memory.
--- @param ptr System.Void* The pointer to beginning of array of struct to reference.
--- @param index number Index of element in array.
--- @return Unity.Collections.LowLevel.Unsafe.T& A reference to a value of type T.
function Unity.Collections.LowLevel.Unsafe.UnsafeUtility.ArrayElementAsRef(ptr, index) end
...
--- @param lhs Unity.Collections.LowLevel.Unsafe.UnsafeUtility.T The first enum to compare.
--- @param rhs Unity.Collections.LowLevel.Unsafe.UnsafeUtility.T The second enum to compare.
--- @return boolean True if equal, otherwise false.
function Unity.Collections.LowLevel.Unsafe.UnsafeUtility.EnumEquals(lhs, rhs) end
