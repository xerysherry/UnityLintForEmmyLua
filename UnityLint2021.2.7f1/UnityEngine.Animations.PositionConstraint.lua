--- @class UnityEngine.Animations.PositionConstraint:UnityEngine.Behaviour Constrains the position of an object relative to the position of one or more source objects.
...
--- @field translationOffset UnityEngine.Vector3 property getset
