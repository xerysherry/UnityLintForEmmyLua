--- @class UnityEngine.Mesh:UnityEngine.Object A class that allows you to create or modify meshes.
...
--- @field indexBufferTarget UnityEngine.GraphicsBuffer.Target property getset
...
--- @param meshCount number The amount of meshes that will be created.
--- @return UnityEngine.Mesh.MeshDataArray Returns a MeshDataArray containing writeable MeshData structs. See Mesh.MeshDataArray and Mesh.MeshData.
...
--- @param attr UnityEngine.Rendering.VertexAttribute The vertex data attribute to check for.
--- @return number Stream index of the data attribute, or -1 if it is not present.
...
--- @param attr UnityEngine.Rendering.VertexAttribute The vertex data attribute to check for.
--- @return number The byte offset within a atream of the data attribute, or -1 if it is not present.
function UnityEngine.Mesh:GetVertexAttributeOffset(attr) end

--- Get vertex buffer stream stride in bytes.
--- @param stream number Vertex data stream index to check for.
--- @return number Vertex data size in bytes in this stream, or zero if the stream is not present.
...
--- @param index number Which vertex buffer to get (some Meshes might have more than one). See vertexBufferCount.
...
--- Sets the vertex buffer size and layout.
--- @param vertexCount number The number of vertices in the Mesh.
--- @param attributes Unity.Collections.NativeArray`1 Layout of the vertex data -- which attributes are present, their data types and so on.
function UnityEngine.Mesh:SetVertexBufferParams(vertexCount, attributes) end
...
--- @param index number Vertex data stream index to get the buffer for.
--- @return UnityEngine.GraphicsBuffer The mesh vertex buffer as a GraphicsBuffer.
...
--- @param desc UnityEngine.Rendering.SubMeshDescriptor[] An array or list of sub-mesh data descriptors.
--- @param start number Index of the first element to take from the array or list in desc.
--- @param count number Number of elements to take from the array or list in desc.
--- @param flags UnityEngine.Rendering.MeshUpdateFlags (Optional) Flags controlling the function behavior, see MeshUpdateFlags.
...
--- Sets information defining all sub-meshes in this Mesh, replacing any existing sub-meshes.
--- @param desc Unity.Collections.NativeArray`1 An array or list of sub-mesh data descriptors.
--- @param start number Index of the first element to take from the array or list in desc.
--- @param count number Number of elements to take from the array or list in desc.
--- @param flags UnityEngine.Rendering.MeshUpdateFlags (Optional) Flags controlling the function behavior, see MeshUpdateFlags.
function UnityEngine.Mesh:SetSubMeshes(desc, start, count, flags) end
...
--- @param uvSetIndex number The UV set index to set the UV distibution metric for. Use 0 for first index.
--- @param uvAreaThreshold number The minimum UV area to consider. The default value is 1e-9f.
