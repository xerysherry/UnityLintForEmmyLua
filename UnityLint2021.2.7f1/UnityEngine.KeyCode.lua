--- @class UnityEngine.KeyCode Key codes returned by Event.keyCode. These map directly to a physical key on the keyboard.
UnityEngine.KeyCode = {
    ...
    --- Left Alt key.
    LeftAlt = 308,
    --- Maps to left Windows key or left Command key if physical keys are enabled in Input Manager settings, otherwise maps to left Command key only.
    LeftMeta = 310,
    --- Left Command key.
    LeftCommand = 310,
    --- Left Command key.
