...
---  
--- @class UnityEngine.UIElements.InputEvent:UnityEngine.UIElements.EventBase`1
...
---  
--- @param previousData string The text before the change occured.
--- @param newData string The new text.
