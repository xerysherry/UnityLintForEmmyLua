...
--- Use this method to prepare per-Camera VFX commands for this frame.
--- @param cam UnityEngine.Camera The Camera to prepare for processing VFX commands.
--- @param camXRSettings UnityEngine.VFX.VFXCameraXRSettings The XR settings that the Visual Effect Graph uses to prepare the Camera.
...
--- @param camXRSettings UnityEngine.VFX.VFXCameraXRSettings The XR settings that the Visual Effect Graph uses to process the Camera commands.
function UnityEngine.VFX.VFXManager.ProcessCameraCommand(cam, cmd, camXRSettings) end
