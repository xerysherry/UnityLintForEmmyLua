--- @class UnityEngine.Networking.UnityWebRequest Provides methods to communicate with web servers.
...
--- @field result UnityEngine.Networking.UnityWebRequest.Result property get
