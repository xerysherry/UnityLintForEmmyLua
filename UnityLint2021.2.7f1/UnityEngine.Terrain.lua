...
--- @field keepUnusedRenderingResources boolean property getset
...
--- @param terrainList UnityEngine.Terrain[] 
...
--- @param value boolean 
function UnityEngine.Terrain:set_keepUnusedRenderingResources(value) end

--- 
--- @param cameraInstanceID number The InstanceID of the camera being queried. See Object.GetInstanceID.
--- @return boolean Returns true if all rendering resources for the given camera are saved regardless of usage. Returns false if garbage collection is allowed to free unused resources.
