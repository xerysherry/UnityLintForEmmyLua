...
--- @field axisOfRotations UnityEngine.ParticleSystemJobs.ParticleSystemNativeArray3 property get
...
---       This array contains the custom data values when you use a CustomDataModule, or when you call SetCustomParticleData.
--- @field meshIndices Unity.Collections.NativeArray`1 property get
