...
--- @param computeBufferStartIndex number Offset in number of elements to which the write operation will occur
--- @param count number Maximum number of elements which will be written
--- @return Unity.Collections.NativeArray`1 A NativeArray of size count
function UnityEngine.ComputeBuffer:BeginWrite(computeBufferStartIndex, count) end
