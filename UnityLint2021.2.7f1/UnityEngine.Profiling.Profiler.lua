...
--- @return number The size of the managed heap.
...
--- @return number Returns a long integer value of the memory in use.
...
--- @param stats Unity.Collections.NativeArray`1 An array to receive the count of free blocks grouped by power of two sizes. Given a small array, Unity counts the larger free blocks together in the final array element.
--- @return number Returns the total number of free blocks in the dynamic heap.
...
--- @param id System.Guid Unique identifier associated with the data.
--- @param tag number Data stream index.
--- @param data table Binary data.
...
--- @param category Unity.Profiling.ProfilerCategory The category you want to enable or disable.
--- @param enabled boolean Enable or disable the collection of data for this category.
...
--- @param category Unity.Profiling.ProfilerCategory Which category you want to check the state of.
--- @return boolean Returns whether or not a given ProfilerCategory is currently enabled.
...
--- @return number Returns number of ProfilerCategory registered in Profiler.
...
--- Returns all ProfilerCategory registered in Profiler.
--- @param categories Unity.Collections.NativeArray`1 
function UnityEngine.Profiling.Profiler.GetAllCategories(categories) end
