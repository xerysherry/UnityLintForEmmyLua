...
--- @param format UnityEngine.RenderTextureFormat The format to look up.
--- @return boolean True if the format can be used for random access writes.
...
--- @param desc UnityEngine.RenderTextureDescriptor The RenderTextureDescriptor to check.
--- @return number If the target platform supports the given MSAA samples count of RenderTextureDescriptor, returns the given MSAA samples count. Otherwise returns a lower fallback MSAA samples count value that the target platform supports.
