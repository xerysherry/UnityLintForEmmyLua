...
--- @field updatePeriod number property getset
...
--- @return UnityEngine.RenderTexture If CustomRenderTexture. doubleBuffered is true, this returns the Render Texture that this Custom Render Texture uses for double buffering. If CustomRenderTexture. doubleBuffered is false, this returns null.
...
function UnityEngine.CustomRenderTexture:set_updatePeriod(value) end
