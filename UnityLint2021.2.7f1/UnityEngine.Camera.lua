...
--- @field onPreCull function Delegate that you can use to execute custom code before a Camera culls the scene.
--- @field onPreRender function Delegate that you can use to execute custom code before a Camera renders the scene.
--- @field onPostRender function Delegate that you can use to execute custom code after a Camera renders the scene.
...
--- @param renderRequests UnityEngine.Camera.RenderRequest[] Requests.
